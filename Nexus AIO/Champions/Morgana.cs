...
namespace Nexus_AIO.Champions
{
    ...
    class Morgana
    {
        ...
        public static readonly MenuSlider comboQRange = new MenuSlider("qrange", "Pick the Q Range", 1200, 1, 3000);
        public static readonly MenuSlider comboWRange = new MenuSlider("wrange", "Pick the W Range", 900, 1, 3000);
        public static readonly MenuSlider comboERange = new MenuSlider("erange", "Pick the E Range", 10, 1, 3000);
        public static readonly MenuSlider comboRRange = new MenuSlider("rrange", "Pick the R Range", 850, 1, 3000);
        ...
        public static void OnChange()
        {
            ...
            switch (qmodus.Index)
            {
                case 0:
                    ...
                    q.SetSkillshot(0.25f, 70f, 1200f, false, SkillshotType.Line);
                    break;
                case 1:
        ...
        {
            var _menu = new Menu("NEXUS AIO", "NEXUS_Morgana", true);
